#include "stdafx.h"
#include "..\Public\PuzzleThird.h"
#include "PositionManager.h"
#include "LoadDatFiles.h"

CPuzzleThird::CPuzzleThird(_pGraphicDevice * pGraphicDevice, _pContextDevice * pContextDevice)
	: CModelObject(pGraphicDevice, pContextDevice)
{
}

HRESULT CPuzzleThird::NativeConstruct(OBJ_INFO tObjInfo)
{
...
_int CPuzzleThird::Tick(_double dTimeDelta)
{
...
_int CPuzzleThird::LateTick(_double dTimeDelta)
{
	m_pRenderer->Add_RenderGroup(CRenderer::RENDER_TEST, this);
	return _int();
}

HRESULT CPuzzleThird::Render()
{
...
void CPuzzleThird::Interaction()
{
}

void CPuzzleThird::Event()
{
}

void CPuzzleThird::Collect_Event()
{
	
}

void CPuzzleThird::Correct_Position(_vector vPosition)
{
	m_pTransform->Set_State(CTransform::STATE_POSITION, vPosition);
}

CPuzzleThird * CPuzzleThird::Create(_pGraphicDevice * pGraphicDevice, _pContextDevice * pContextDevice, OBJ_INFO tObjInfo)
{
	CPuzzleThird* pInstance = new CPuzzleThird(pGraphicDevice, pContextDevice);
