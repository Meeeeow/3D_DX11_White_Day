#include "stdafx.h"
#include "..\Public\PuzzleFirst.h"
#include "PositionManager.h"
#include "LoadDatFiles.h"
#include "FuseBody.h"

CPuzzleFirst::CPuzzleFirst(_pGraphicDevice * pGraphicDevice, _pContextDevice * pContextDevice)
	: CModelObject(pGraphicDevice, pContextDevice)
{
}

HRESULT CPuzzleFirst::NativeConstruct(OBJ_INFO tObjInfo)
{
...
_int CPuzzleFirst::Tick(_double dTimeDelta)
{
...
_int CPuzzleFirst::LateTick(_double dTimeDelta)
{
	m_pRenderer->Add_RenderGroup(CRenderer::RENDER_TEST, this);
	return _int();
}

HRESULT CPuzzleFirst::Render()
{
...
void CPuzzleFirst::Interaction()
{
}

void CPuzzleFirst::Event()
{
}

void CPuzzleFirst::Collect_Event()
{
	
}

void CPuzzleFirst::Correct_Position(_vector vPosition)
{
	m_pTransform->Set_State(CTransform::STATE_POSITION, vPosition);
}

CPuzzleFirst * CPuzzleFirst::Create(_pGraphicDevice * pGraphicDevice, _pContextDevice * pContextDevice, OBJ_INFO tObjInfo)
{
	CPuzzleFirst* pInstance = new CPuzzleFirst(pGraphicDevice, pContextDevice);
